/**
 * Dies ist ein Programm zur Verwaltung des Autobestands in einem Autohaus
...
/*
Diese Struktur beschreibt ein Auto
*/
typedef struct {
    char marke[21];
...
/**
 * Diese Funktion erstellt ein neues Auto
 * @param marke Die Marke des Autos
 * @param hoechstgeschwindigkeit Die Höchstgeschwindigkeit des Autos
 * @param tuerenanzahl Die Anzahl der Türen des Autos
 * @param abs 1, wenn das Auto ABS hat, 0 sonst
 * @param sonderausstattung Die Sonderausstattung des Autos
 * @param ps Die PS des Motors des Autos
 * @param zylinder Die Zylinder des Motors des Autos
 * @param hubraum Der Hubraum des Motors des Autos
 * @return Das neue Auto
 */
...
/**
 * Diese Funktion schätzt den Wert eines Autos
 * @param aut Das Auto
 * @return Der Wert des Autos
*/
...
/**
 * Diese Funktion druckt ein Auto als String aus
 * @param aut Das Auto
 * @return Der String des Autos
*/
...
/**
 * Diese Funktion fügt ein Auto dem Autohaus hinzu
 * @param aut Das Auto
*/
...
/**
 * Diese Funktion entfernt ein Auto aus dem Autohaus
 * @param index Der Index des Autos
*/
...
/**
 * Diese ist das Main Programm zur Verwaltung des Autobestands in einem Autohaus
*/
int main() {
    char marke[21];
    int hoechstgeschwindigkeit;
