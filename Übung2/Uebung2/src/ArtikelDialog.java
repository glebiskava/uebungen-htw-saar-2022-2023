...
public class ArtikelDialog {
    ...
    /**
     * Führt die jeweilige Funktion aus, die vom Benutzer gewählt wurde.
    ...
    public void artikelAnlegen() {
        if(artikel != null) {
            ...
            artikel = new Artikel(artikelNr, artikelArt, artikelBestand);
        }
    }
     ...
     * @param args
     */
    public static void main(String args[]) {new ArtikelDialog().dialogStart();}
}
