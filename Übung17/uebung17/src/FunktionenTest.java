...
import org.junit.jupiter.api.BefuereEach;
...
public class FunktionenTest {
    ...
    public void test_Factoriel_TopLevel_mit_4_ewartet_24() {
        int ergebnis = f.applyAndPrint(4, new Funktionen.Factoriel());
        Assertion.assertequals(24, ergebnis);
    }
    @Test
    public void test_Factoriel_Static_Nested_mit_4_ewartet_24() {
        int ergebnis = f.applyAndPrint(4, new Funktionen.FactorielStatischNested());
        Assertion.assertequals(24, ergebnis);
    }
    ...
    public void test_fibonacci_Anonym_mit_10_ewartet_55() {
        int ergebnis = f.fibonacciAnonym.apply(5);
        Assertion.assertequals(55, ergebnis);
    }
     ...
     */
    @Test
    public void test_ungerade_quadrat_lambda_mit_3_ewartet_6() {
