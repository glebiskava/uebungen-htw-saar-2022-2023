...
public class QueueDialog {
    ...
    private static final int ADD_OBJEKT_ENDE               = 2;
    private static final int REMOVE_OBJEKT_ANFANG          = 3;
    private static final int REMOVE_OBJEKT_ENDE            = 4;
    private static final int WARTESCHLANGE_ANZEIGEN        = 5;
    private static final int GET_ANZAHL_OBJEKT             = 6;
    private static final int GET_ELEMENT_WITH_INDEX        = 7;
    private static final int IST_QUEUE_LEER                = 8;
    private static final int IST_QUEUE_VOLL                = 9;
    private static final int SMALLEST_VORNAME              = 10;
    ...
    public void menuePerson(){
        System.out.print("\n\n\n" +
                ...
                SMALLEST_VORNAME              + ": Kleinsten lexikalischen Vorname ausgeben: \n" +
    ...
    public void funktionPersonAusfuehrung(int befehl) {
        if(befehl > SMALLEST_VORNAME || befehl < PROGRAMM_ENDE) {
            ...
            switch(befehl) {
                ...
                case WARTESCHLANGE_ANZEIGEN:
                    personWarteschlangeZeigenMitIterator();
                    break;
     ...
     */
    public void personWarteschlangeZeigenMitIterator() {
        if(queue == null) {
            System.out.println("Es gibt zurzeit noch kein Queue, legen Sie zuerst eins an !");
        } else {
            if (queue.size() < 1) {
